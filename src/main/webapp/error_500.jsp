...
<head>
<title>错误页面</title>
        <script type="text/javascript" src="${basePath}/plug-in/jquery.min.js"></script>
<script>
...
-->
    ...
    <body>
        <table width="100%">
            <tr>
                <td style="border-bottom:dotted 1px Gray;" colspan="2" ><span class="STYLE1">Sorry！错误提示</span></td>
            </tr>
            <tr>
