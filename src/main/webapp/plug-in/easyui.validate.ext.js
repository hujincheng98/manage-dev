$.extend($.fn.validatebox.defaults.rules,
{
	...
	resUrl : {
		validator : function(value) {
			return /^([a-zA-Z/?_=]*)\.\w{1,5}?$/i.test(value);
		},
		message : '路径格式不正确，路径格式：/test/index.json'
	},
	baseResUrl : {
		validator : function(value) {
			return /^(([a-zA-Z/?_=]*)\.\w{1,5})(@(([a-zA-Z/?_=]*)\.\w{1,5})*)*?$/i.test(value);
		},
		message : '路径格式不正确，多个路径使用@隔开，路径格式：/test/index.json'
	},
	...
	xlsFile : {
		...
		message : '请选择xls(xlsx)格式的excel文件!'
	},
});